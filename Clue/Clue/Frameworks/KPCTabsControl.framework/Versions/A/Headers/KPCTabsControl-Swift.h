...
- (NSPoint)tabButtonOffsetWithPosition:(enum TabPosition)position SWIFT_WARN_UNUSED_RESULT;
- (BorderMask)tabButtonBorderMask:(enum TabPosition)position SWIFT_WARN_UNUSED_RESULT;
- (IconFrames * _Nonnull)iconFramesWithTabRect:(NSRect)rect SWIFT_WARN_UNUSED_RESULT;
- (NSRect)titleRectWithTitle:(NSAttributedString * _Nonnull)title inBounds:(NSRect)rect showingIcon:(BOOL)showingIcon SWIFT_WARN_UNUSED_RESULT;
- (TitleEditorSettings * _Nonnull)titleEditorSettings SWIFT_WARN_UNUSED_RESULT;
- (NSAttributedString * _Nonnull)attributedTitleWithContent:(NSString * _Nonnull)content selectionState:(enum TabSelectionState)selectionState SWIFT_WARN_UNUSED_RESULT;
@property (nonatomic, readonly) CGFloat tabsControlRecommendedHeight;
- (BorderMask)tabsControlBorderMask SWIFT_WARN_UNUSED_RESULT;
...
+ (NSButton * _Nonnull)auxiliaryButtonWithImageNamed:(NSString * _Nonnull)imageName target:(id _Nullable)target action:(SEL _Nullable)action SWIFT_WARN_UNUSED_RESULT;
@end


@interface NSColor (SWIFT_EXTENSION(KPCTabsControl))
- (NSColor * _Nonnull)darkerColor SWIFT_WARN_UNUSED_RESULT;
@end


@interface NSImage (SWIFT_EXTENSION(KPCTabsControl))
- (NSImage * _Nonnull)imageWithTint:(NSColor * _Nonnull)tint SWIFT_WARN_UNUSED_RESULT;
@end
...
- (id _Nonnull)copy SWIFT_WARN_UNUSED_RESULT;
+ (NSImage * _Nonnull)popupImage SWIFT_WARN_UNUSED_RESULT;
- (BOOL)hasRoomToDrawFullTitleInRect:(NSRect)rect SWIFT_WARN_UNUSED_RESULT;
- (NSSize)cellSizeForBounds:(NSRect)aRect SWIFT_WARN_UNUSED_RESULT;
- (BOOL)trackMouse:(NSEvent * _Nonnull)theEvent inRect:(NSRect)cellFrame ofView:(NSView * _Nonnull)controlView untilMouseUp:(BOOL)flag SWIFT_WARN_UNUSED_RESULT;
- (NSRect)titleRectForBounds:(NSRect)theRect SWIFT_WARN_UNUSED_RESULT;
...
- (void)finishEditingWithFieldEditor:(NSText * _Nonnull)fieldEditor newValue:(NSString * _Nonnull)newValue;
- (NSRect)editingRectForBounds:(NSRect)rect SWIFT_WARN_UNUSED_RESULT;
...
/// Reloads all tabs of the tabs control. Used when the <code>dataSource</code> has changed for instance.
- (void)reloadTabs;
...
/// Starts editing the tab as if the user double-clicked on it. If <code>index</code> is out of bounds, it does nothing.
...
- (CGFloat)currentTabWidth SWIFT_WARN_UNUSED_RESULT;
